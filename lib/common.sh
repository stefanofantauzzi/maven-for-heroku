...
export DEFAULT_MAVEN_VERSION="3.8.4"
...
install_maven() {
  ...
  local mavenUrl="https://archive.apache.org/dist/maven/maven-3/${mavenVersion}/binaries/apache-maven-${mavenVersion}.tar.gz" rollback maybe?
